...
document.addEventListener('DOMContentLoaded', function () {
  ...
  _reactDom2.default.render(_react2.default.createElement(_clock2.default, null), root);
  _reactDom2.default.render(_react2.default.createElement(_tabs2.default, { tabs: [{ title: "one", content: "first" }, { title: "two", content: "second" }] }), document.getElementById('tabs'));
});
...
var Tabs = function (_React$Component) {
  ...
  _createClass(Tabs, [{
    ...
    value: function render() {
      // debugger
      var tab = this.props.tabs[this.state.selected];
...
var Headers = function (_React$Component2) {
  _inherits(Headers, _React$Component2);
